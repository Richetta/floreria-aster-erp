...
export const SettingsMobile = () => {
    ...
    const [theme, setTheme] = useState(localStorage.getItem('mi jard韓-theme') || 'violet');
    const { alertModal, confirmModal, showAlert, showConfirm } = useModal();

    const themes = [
        { id: 'violet', color: '#4F7A5A', name: 'mi jard韓 Violet' },
    ...
    const handleThemeChange = (id: string) => {
        ...
        if (themeObj) {
            ...
            localStorage.setItem('mi jard韓-theme', id);
            showAlert({ title: 'Tema actualizado', message: `Se aplic贸 el estilo ${themeObj.name}`, variant: 'success' });
        }
    };
    ...
    const handleLogout = async () => {
        const confirmed = await showConfirm({
            ...
            message: 'Tendr谩s que ingresar tus credenciales nuevamente.',
        ...
        <div className="settings-mobile-wrapper">
            ...
            <div className="settings-scroll-content">
                    ...
                    <div className="settings-menu-list">
                        <div className="menu-item-row" onClick={() => navigate('/configuracion')}>
                            ...
                            <div className="m-text">
                                <span className="m-title">Informaci贸n General</span>
                        ...
                        <div className="menu-item-row" onClick={() => navigate('/configuracion')}>
                            ...
                            <div className="m-text">
                                <span className="m-title">Direcci贸n y Contacto</span>
                ...
                <section className="settings-section">
                    ...
                    <div className="settings-menu-list">
                        <div className="menu-item-row" onClick={() => {
                            // TODO: Navigate to user management when route exists
                            console.log('Navigate to user management');
                        }}>
                            <span className="material-symbols-rounded m-icon">group</span>
                            <div className="m-text">
                                <span className="m-title">Gestionar Usuarios</span>
                                <span className="m-sub">Admin, Vendedores, Repartidores</span>
                            </div>
                            <span className="material-symbols-rounded m-arrow">chevron_right</span>
                        </div>
                        <div className="menu-item-row" onClick={() => {
                ...
                <section className="settings-section">
                    ...
                    <p className="app-version">Florer铆a mi jard韓 ERP v2.5.0</p>
                </section>
            </div>
