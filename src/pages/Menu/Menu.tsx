...
const menuGroups = [
    {
        title: 'Operaciones',
        items: [
            { path: '/', icon: LayoutDashboard, label: 'Dashboard', desc: 'Resumen del d铆a' },
            { path: '/pos', icon: ShoppingCart, label: 'Venta R谩pida', desc: 'Nueva venta' },
            { path: '/pedidos', icon: Truck, label: 'Pedidos', desc: 'Gesti贸n de entregas' },
            { path: '/logistica', icon: Navigation, label: 'Log铆stica', desc: 'Rutas de reparto' },
        ]
    },
    {
        title: 'Inventario',
        items: [
            ...
            { path: '/mermas', icon: Trash2, label: 'Mermas', desc: 'P茅rdidas y desperdicio' },
        ]
    },
    {
        title: 'Contactos',
    ...
    },
    {
        ...
        items: [
            ...
            { path: '/configuracion', icon: Settings, label: 'Ajustes', desc: 'Configuraci贸n general' },
        ]
    },
];
    ...
    return (
        <div className="menu-page p-6 pb-24">
            <header className="menu-header mb-8">
                <h1 className="text-h1">Men煤 General</h1>
                <p className="text-body text-muted">Todos los m贸dulos del sistema agrupados.</p>
            </header>
            ...
            <div className="menu-footer text-center mt-4">
                <p className="text-micro text-muted">mi jard韓 ERP v1.0.0</p>
            </div>
        </div>
    );
};
